# Operator Quickstart — cloud-itonami-isic-7830

Shortest path from clone to a verified local dry-run for **ISIC 7830** (`cloud-itonami-isic-7830`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7830.git
